...
@section('content')
    <div class="container-fluid header bg-white p-0" style="margin-bottom: -70px">
        <div class="row p-5">
            <div class="col-md-6 col-sm-12 mt-md-5 py-md-5 mx-auto wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="display-5">Daftar</h1>
                <p class="mb-4">
            ...
            <div class="col-md-6 col-sm-12 mt-md-5 py-md-5 mx-auto wow fadeInUp d-none d-md-block justify-content-center text-center"
                data-wow-delay="0.3s">
                <svg xmlns="http://www.w3.org/2000/svg" width="564px" class="mt-md-5" viewBox="0 0 564.98435 512.2962"
                    ...
                    <path d="M264.23446,133.5s14-4,17,2,10,85,10,85l-13.5,63.05905-15.5-4.05905,8-64-11-48,5-34Z"
                        fill="#e6e6e6" />
                    <g>
                        <circle cx="58.49998" cy="266.83965" r="58.49999" fill="#00b98e" />
                        <path
