...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <flux:sidebar sticky collapsible class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 flex flex-col justify-between h-screen overflow-hidden">
            ...
            {{-- Middle Scrollable Nav with Collapsible Dropdown Accordion Groups --}}
            <flux:sidebar.nav class="flex-1 overflow-y-auto pr-1 py-2 space-y-1.5">
                ...
                {{-- 2. Master Data (Collapsible Dropdown Group) --}}
                ...
                {{-- 3. Akademik & Operasional (Collapsible Dropdown Group) --}}
                <flux:sidebar.group 
                ...
                @if (auth()->user()->role === \App\Enums\UserRole::Admin)
                    {{-- 4. Konten Website (Collapsible Dropdown Group) --}}
                    ...
                    {{-- 5. Administrasi & Sistem (Collapsible Dropdown Group) --}}
                    <flux:sidebar.group 
